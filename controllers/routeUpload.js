...
const db = require("../Db/Db"); // <-- Use your actual import path and variable name
...
router.post("/upload", upload.single("image"), async function (req, res) {
  ...
  const { luid, payment_date, amount, payer_role } = req.body;
  ...
  try {
    ...
    const insertQuery = `
        INSERT INTO PaymentVerification (luid, payment_date, receipt_url, amount, payer_role)
        VALUES (?, ?, ?, ?, ?);
    `;
